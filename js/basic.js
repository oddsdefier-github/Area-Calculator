...
function areaRect(length, width) {
    if (isNaN(length) || isNaN(width) || length <= 0 || width <= 0) {
        ...
        <div class="text-yellow-800 text-sm" role="alert"><span class="font-medium">Error:</span> Please enter valid and positive numeric values for length and width.</div>
    </div>`;
    } else {
